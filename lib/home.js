document.addEventListener("DOMContentLoaded", () => {
    ...
    ScrollTrigger.matchMedia({
        "(min-width: 1024px)": function () {
            ...
            tl.to(shape1, { opacity: 1, duration: .2, ease: 'power3.out' }, '+=0.1')
            .to(shape2, { opacity: 1, duration: 1.2, ease: 'power3.out' }, '>')
            ...
            .to(date, { opacity: 1, duration: 1.0, ease: 'power2.out' }, '+=0.3') // 날짜
            ...
            .to(hex2, { y: 0, opacity: 1, duration: 1.2, ease: 'power3.out' }, '-=0.1')
