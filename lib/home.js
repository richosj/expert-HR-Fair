document.addEventListener("DOMContentLoaded", () => {
    ...
    ScrollTrigger.matchMedia({
        "(min-width: 1024px)": function () {
            ...
            .to(year, { y: 0, opacity: 1, duration: 1, ease: 'power3.out' })
            .to([year, fair], {
                x: '0%',
                opacity: 1,
                duration: 1.0,
            ...
            .to(s2title, { opacity: 1, y: 0, duration: .7, ease: 'power3.out' }, '>')
            .to(s2title2, { opacity: 1, y: 0, duration: .7, ease: 'power3.out' }, '>')
            tl.to(hex1, {
                opacity: 1,
                scale: 1.15,
                duration: 0.3,
