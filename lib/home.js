document.addEventListener("DOMContentLoaded", () => {
    ...
    ScrollTrigger.matchMedia({
        "(min-width: 1024px)": function () {
            ...
            .to(year, { y: 0, opacity: 1, duration: .5, ease: 'cubic-bezier(0.165, 0.84, 0.44, 1)' })
            .to([year, fair], {
                x: '0%',
                opacity: 1,
                duration: .6,
            ...
            .to(shape3, { opacity: 1, duration: 1, ease: 'power3.out' }, '<')
            .to(shape4, { opacity: 1, duration: 1, ease: 'power3.out' }, '<')
            .to(hex1, {
                opacity: 1,
                duration: 0.3,
                ease: 'sine.inOut',
            ...
            .to(shape5, { opacity: 1, duration: 1, ease: 'power3.out' }, '>')
